...
public class M_ProductsGUI_Sta extends JFrame {
	...
	public M_ProductsGUI_Sta()
	{
		...
		btnDelete.setBounds(1051, 384, 89, 23);
		...
		JLabel lblDeleteupdateByProduct = new JLabel("DELETE BY PRODUCT ID");
		...
		public void showInfoSupplier()
		{
			...
			final Object[] row = new Object[4];//5 column for each row
